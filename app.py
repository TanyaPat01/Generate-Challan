...
def process_image(input_path, output_folder, model, imgsz=320):
    results = model([input_path], imgsz=imgsz)
    detected = False
...
def index():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            return render_template('Index_1.html', result=result_message, helmet_img=helmet_img_base64, license_plate_img=license_plate_img_base64, allChallan=allChallan)
